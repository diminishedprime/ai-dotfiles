...
[MathJax] and [KaTeX] are two popular libraries for displaying mathematical
content in browsers. Although both libraries offer similar functionality, they
...
[KaTeX] within your project, add the following lines to your configuration:
...
=== "`docs/javascripts/katex.js`"
    ...
    1. This integrates KaTeX with [instant navigation].
